...
from modules.fft.fft import getFFT
from modules.fft.utils import *
...
class Stream_Analyzer:
    ...
    def __init__(self,
        ...
        try:
            from modules.fft.stream_reader_pyaudio import Stream_Reader
            ...
            from modules.fft.stream_reader_sounddevice import Stream_Reader
            self.stream_reader = Stream_Reader(
                device  = device,
                rate    = rate,
                updates_per_second  = updates_per_second,
        ...
        if self.visualize:
            from modules.fft.visualizer import Spectrum_Visualizer
    ...
    def stop(self):
        ...
        try:
            if hasattr(self, 'stream_reader') and self.stream_reader is not None:
                self.stream_reader.stream_stop()
